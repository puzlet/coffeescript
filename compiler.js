...
(function() {
  ...
  Compiler = (function() {
    ...
    Compiler.prototype.compile = function(code) {
      ...
      compile = (_ref = this.spec.compile) != null ? _ref : $coffee.compile;
      this.js = compile(this.code);
  ...
  Inspector = (function() {
    ...
    function Inspector(obj, opts) {
      ...
      if ((_base = this.ctx).showHidden == null) {
        _base.showHidden = false;
      }
      if ((_base1 = this.ctx).depth == null) {
        _base1.depth = 2;
      }
      if ((_base2 = this.ctx).keysLimit == null) {
        _base2.keysLimit = 20;
      }
      if ((_base3 = this.ctx).arrayLimit == null) {
        _base3.arrayLimit = 20;
      }
      if ((_base4 = this.ctx).processJQuery == null) {
        _base4.processJQuery = false;
      }
      if ((_base5 = this.ctx).processNumericJs == null) {
        _base5.processNumericJs = false;
      }
      if ((_base6 = this.ctx).colors == null) {
        _base6.colors = false;
      }
      if ((_base7 = this.ctx).customInspect == null) {
    ...
    Inspector.prototype.formatValue = function(value, recurseTimes) {
      ...
      if (baseInfo.array) {
        ...
        output = keys.map((function(_this) {
          return function(key) {
    ...
    Inspector.prototype.formatProperty = function(value, recurseTimes, visibleKeys, key, array) {
      ...
      property = new ObjectProperty({
        ...
        array: array,
        ctx: this.ctx,
        formatValue: (function(_this) {
          return function(v, recurse) {
